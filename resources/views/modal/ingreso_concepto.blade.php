    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
                ...
                <div id="" class="col-lg-12">
                    <div class="form-row mb-2">
                        <div class="form-group col-md-6">
                            ...
                            <input id="descripcion_concepto" type="text" class="form-control" placeholder="Descripcion">
                        </div>

                        <div class="form-group col-md-6">
                            <label for="inputEmail4">Precio</label>
                            <input id="precio_concepto" type="text" class="form-control text-right" value="0" onkeyup="punto_decimal_limite(this)">
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="add_concepto_ingreso" onclick="grabar_ingreso()">Guardar</button>
            </div>
        </div>
    </div>
</div>
