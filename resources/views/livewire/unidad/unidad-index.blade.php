<div class="layout-px-spacing mt-4">
    ...
    <div class="row layout-spacing">
        <div class="col-lg-10 col-md-10 col-sm-12">
            <h2 class="w-25 p-3">Unidad de Medida</h2>
        </div>
        @can('tipocurso.create')
            <div class="col-lg-2 col-md-10 d-flex align-items-center">
                <button type="button" class="btn btn-info" data-toggle="modal_agregar" data-target=".bd-example-modal-lg">Agregar</button>
            </div>
        @endcan
