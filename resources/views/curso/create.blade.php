        ...
        <div id="flFormsGrid" class="col-lg-12 layout-spacing">
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <form action="{{route('curso.store')}}" method="POST" enctype="multipart/form-data" onsubmit="disableButton()">
                        @csrf
                        <div class="form-row mb-2">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select name="estado_id" id="estado_id" class="form-control">
                                    <option {{ (old('tipo_curso_id')== 1 ? 'selected' : '') }} value="1">ACTIVO</option>
                                    <option {{ (old('tipo_curso_id')== 2 ? 'selected' : '') }} value="2">INACTIVO</option>
                                </select>
                            </div>
                        </div>
