<div wire:ignore.self class="modal fade bd-example" id="modal_buscar" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                ...
                <div id="" class="col-lg-12">
                    <div class="form-row mb-2">
                        <div class="form-group col-md-12">
                            ...
                            @if ($ver_error)
                                <span role="alert" id="buscar_documento" style="color: red; padding: 2px 2px">{{$mensaje_error}}</span>
                            @endif
                        </div>
