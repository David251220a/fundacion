    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myLargeModalLabel">Cobro Certificado</h5>
                ...
                <div id="" class="col-lg-12">
                    <div class="form-row mb-2">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select wire:model.defer="cer_forma_pago_id" class="form-control">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" wire:model.defer="cer_comprobante" class="form-control" accept="image/*">
                            @error('cer_comprobante')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input wire:model.defer="precio_certificado" id="precio_certificado" type="text" class="form-control text-right" readonly>
                        </div>

                        <div class="form-group col-md-6">
                            <label for="inputPassword4">Total a Pagar</label>
                            <input wire:model.defer="cer_total_pagar_modal" type="text" class="form-control text-right"
                            onkeyup="punto_decimal_limite_precio_certificado(this)" >
                            @error('cer_total_pagar_modal')
